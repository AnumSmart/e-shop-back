...
func (h *AuthHandler) LoginHandler(c *gin.Context) {
	...
	accessToken, refreshToken, err := jwtObject.GenerateTokens(user.Email)
	if err != nil {
...
func (h *AuthHandler) ProcessRefreshTokenHandler(c *gin.Context) {
	...
	newAccessTokenClaims := jwt_stuff.NewClaims(h.config.Auth.AccessTokenExp, email, "access", "my_app")
